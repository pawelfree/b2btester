...
public class MessageDataSourceDAO extends DataSourceDAO implements MessageDAO {
   ...
   // find the ref to message
     ...
     * @return a List of DVO resulted from the specified SQL query. An empty List will be returned if there is no
     * matching data.
    ...
    // Since H20 01062007
    /**
     * Update the status of all timed-out message to
     * <code>status</code>. A message is considered as timed-out if the timeout timestamp is earlier than the
     * <code>currentTime</code>.
     *
     * @throws DAOException When <code>status</code> is null or Error in persistence connectivity.
     *
